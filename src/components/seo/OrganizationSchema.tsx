...
// company. The group name is held constant to avoid conflating the two
// Canwells; the description and subOrganizations are derived from CMS content
// so the schema, the page and the brand list never drift apart.
const schema = {
